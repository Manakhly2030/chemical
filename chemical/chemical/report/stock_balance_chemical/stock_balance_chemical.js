...
function view_stock_leder_report(item_code,company, from_date, to_date, warehouse) {
	window.open(window.location.href.split("#")[0] + "#query-report/Stock Ledger" + "/?" + "item_code=" + item_code + "&" + "company=" + company + "&" + "from_date=" + from_date + "&" + "to_date=" + to_date + "&" + "warehouse=" + warehouse,"_blank")	
}
