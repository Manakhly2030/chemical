...
function view_stock_leder_report(item_code, filter_company,from_date, to_date, batch_no) {
	console.log(to_date)
	window.open(window.location.href.split('app')[0] + "app/query-report/Stock Ledger" + "?" + "company="  + filter_company + "&"  + "from_date=" + from_date + "&" + "to_date=" + to_date + "&" + "item_code=" + item_code  + "&" + "batch_no=" + batch_no,"_blank")
