...
work_order_create.fg_warehouse = frappe.db.get_value("Warehouse",{ "warehouse_name":"FINISHED GOODS(STANDARD)"},"name")
...
company =  frappe.db.get_value("Company",{},"company_name") #it will Fetch the First Name of the Company from the list
warehouse =  frappe.db.get_value("Warehouse",{'company':company, "warehouse_name":"FINISHED GOODS(STANDARD)"},"name") 
cost_center = frappe.db.get_value("Company",company,"cost_center")

second_si = frappe.new_doc("Sales Invoice")
second_si.naming_series = "Test-SI-.###"
second_si.customer = "Test_Customer_1"
second_si.set_posting_time = 1
